  ...
  try {
    ...
    lineItems.push({
      price_data: {
        currency: "eur",
        product_data: {
          name: `Kennzeichen ${plateText} (${material === "carbon" ? "Carbon" : "Standard"}, ${size === "klein" ? "460\xD7110mm" : "520\xD7110mm"})`,
          description: "2 Schilder, DIN-zertifiziert"
        },
        unit_amount: material === "carbon" ? 2e3 : 1e3
      },
      quantity: 1
    });
    if (addons.zulassung) {
    ...
    if (addons.plakette) {
      lineItems.push({
        price_data: {
          currency: "eur",
          product_data: { name: "Umweltplakette", description: "Gr\xFCne Umweltplakette" },
          unit_amount: 500
        },
        quantity: 1
      });
...
// ../.wrangler/tmp/pages-7i61Kr/functionsRoutes-0.9140978604677046.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-3DPmty/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-3DPmty/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.21458280318394496.mjs.map
